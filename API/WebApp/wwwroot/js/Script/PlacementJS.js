...
$(document).ready(function () {
    debugger
    table = $("#PlacementTabel").DataTable({
        "processing": true,
        "responsive": true,
        "pagination": true,
        "stateSave": true,
        "ajax": {
            url: "/placements/LoadPlace",
            type: "GET",
            dataType: "json",
            dataSrc: "",
        },
...
function Save() {
    ...
    Div.placementdate = $('#PlacementDate').val();
    Div.placementenddate = $('#PlacementEndDate').val();
    Div.siteId = $('#SiteOption').val();
    $.ajax({
        type: 'POST',
        url: "/placements/InsertOrUpdate/",
        cache: false,
        dataType: "JSON",
        data: Div
    }).then((result) => {
